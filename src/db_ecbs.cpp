...
int main(int argc, char *argv[]) {
  ...
  desc.add_options()("help", "produce help message")(
      ...
      "input file (yaml)")("output,o",
                           ...
                           "output file (yaml)")(
      "optimization,opt", po::value<std::string>(&optimizationFile)->required(),
      "optimization file (yaml)")(
      "stats,s", po::value<std::string>(&statsFile)->required(),
      "stats file (yaml)")("cfg,c",
  ...
  for (auto &robotType : problem.robotTypes) {
    ...
    if (robotType == "unicycle1_v0" || robotType == "unicycle1_sphere_v0") {
      ...
      motionsFile = "../new_format_motions/unicycle1_3d_v0/"
                    "unicycle1_3d_v0.bin.im.bin.sp.bin";
      ...
      motionsFile = "../new_format_motions/integrator2_3d_v0/long_50_5000/"
      ...
      motionsFile = "../new_format_motions/integrator2_3d_v0/residual/"
                    "long_50_5000/integrator2_3d_v0.bin.im.bin.sp.bin";
    } else {
  ...
  for (const auto &robot : robots) {
    ...
    if (robot_motions.find(problem.robotTypes[i]) == robot_motions.end()) {
      ...
      load_motion_primitives_new(options_tdbastar.motionsFile, *robot,
                                 ...
                                 options_tdbastar.cut_actions, /*shuffle*/ true,
  ...
  for (size_t iteration = 0;; ++iteration) {
    ...
    std::cout << "ITR: " << iteration
              << ", MOTIONS: " << options_tdbastar.max_motions
              << ", delta: " << options_tdbastar.delta << std::endl;
    solved_db = false;
